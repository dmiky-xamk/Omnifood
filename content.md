...
- Logo + Navigation
- Hero
- Featured in (Usually right after or in the hero)
- How it works
- Meals (and list of diets)
- Testimonials + Gallery
- Call to action (CTA) (Usually last section before the footer) (Can include featured in)
- Pricing (usually low in the page, can be after the CTA) + Features
- Footer